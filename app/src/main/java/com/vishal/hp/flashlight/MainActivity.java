package com.vishal.hp.flashlight;
...
public class MainActivity extends Activity {
    ...
    public void turnOnLight() {
        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                playOnOffSound();
                ivOnOFF.setImageResource(R.drawable.flashlight_on);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void turnOffLight() {
        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                playOnOffSound();
                ivOnOFF.setImageResource(R.drawable.flashlight_off);
    ...
    private void playOnOffSound() {
        objMediaPlayer = MediaPlayer.create(MainActivity.this, R.raw.light_switch_off);
